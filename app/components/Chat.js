...
function Chat() {
  ...
  useEffect(() => {
    socket.current = io(process.env.BACKENDURL || "https://randommusings.onrender.com");
  ...
  return (
    <div id="chat-wrapper" className={"chat-wrapper shadow border-top border-left border-right " + (appState.isChatOpen ? "chat-wrapper--is-visible" : "")}>
      ...
      <form onSubmit={handleSubmit} id="chatForm" className="chat-form border-top">
        <input value={state.chatValue} onChange={handleChat} ref={chatField} type="text" className="chat-field" id="chatField" placeholder="Type a message…" autoComplete="off" />
      </form>
    </div>
  );
}
